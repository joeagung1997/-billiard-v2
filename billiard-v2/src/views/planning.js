...
export function planningPage({ items = [], goals = [], token = "", role = "owner", displayName = "" } = {}) {
  ...
  return docHeadV4("Planning & Roadmap")
    ...
    +       "<div class=\"plan-proj-empty\">Isi <b>Jumlah</b> per bulan untuk lihat list cicilan &amp; tanggal selesai.</div>"
    +       "<div class=\"plan-proj-presets-wrap\">"
    +         "<span class=\"plan-proj-presets-lbl\">Atau bagi otomatis:</span>"
    +         "<button type=\"button\" class=\"plan-proj-preset\" onclick=\"_planSplitBy(3)\">Bagi 3 bln</button>"
    +         "<button type=\"button\" class=\"plan-proj-preset\" onclick=\"_planSplitBy(6)\">Bagi 6 bln</button>"
    +         "<button type=\"button\" class=\"plan-proj-preset\" onclick=\"_planSplitBy(12)\">Bagi 12 bln</button>"
    +         "<button type=\"button\" class=\"plan-proj-preset\" onclick=\"_planSplitBy(24)\">Bagi 24 bln</button>"
    +       "</div>';"
