...
const MON_CSS = [
  ...
  ".mon-table td{padding:10px 14px;font-size:12px;color:var(--txt2);border-bottom:1px solid var(--border);vertical-align:middle}",
  ".mon-table tr:last-child td{border-bottom:none}",
  ".mon-table tr:hover td{background:rgba(255,255,255,.02)}",
  ...
  ".mon-empty{text-align:center;padding:40px 20px;color:var(--txt3);font-size:13px}",
  ".mon-empty i{font-size:32px;display:block;margin-bottom:10px;opacity:.4}",
